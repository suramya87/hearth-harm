...
/// <summary>
/// Handles Unity Relay sign-in, host creation, and client joining.
/// </summary>
public class NetworkBootstrapper : MonoBehaviour
{
    ...
    // ── RelayServerData builders ───────────────────────────────────────────
    // The old RelayServerData(allocation, "dtls") 2-arg constructor was removed
    // in Unity Relay SDK 1.1+. Build it manually from the allocation fields.
    ...
    private static RelayServerData BuildRelayServerData(Allocation allocation)
    {
        return new RelayServerData(
            ...
            allocation.Key,
            true                        // isSecure / DTLS — positional, no named param
        );
    }
